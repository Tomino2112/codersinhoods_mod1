...
const hoverOver = () =>{
  ...
  anchor.addEventListener("mouseover",() =>{
    console.log("oohhh look a ButterFLy");
  })
}
/**
 * Exercise 3
...
const handleLeave = () => {
  ...
  anchor.addEventListener("mouseout", ()=> {
    console.log("Be freee Butterfly!");
  })
}
/**
 * Exercise 4
...
const clickElsewhere = () => {
  ...
  input.addEventListener("blur", ()=>{
    console.log("I said FOCUSS DAMNIT!!!")
  })
 ...
 */
 const pressAKey = () => {
  ...
  input.addEventListener("keydown", ()=>{
    console.log("Jhonny 5 need more input!!")
  })
 ...
 */
 const releaseAKey = () => {
  ...
  input.addEventListener("keyup", ()=>{
    console.log("NO NO, need more input!!")
  })
...
const submitFormHandler = () => {
  ...
  formInputs.firstName = firstName.value;
  formInputs.lastName = lastName.value;
