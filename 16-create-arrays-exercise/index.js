 ...
 */
function animalIndex(animal){
  return animal === 'dog';
}
const dogIndex = animals.findIndex(animalIndex);
/**
 * Exercise 5
 *
...
const moreThanFour = numbers[numbers.findIndex(greaterThan)];
 ...
 */
function greaterOrEqualto(checkNumber) {
   return checkNumber >= 7;
 }

 const moreEqualThanSeven = numbers.findIndex(greaterOrEqualto);